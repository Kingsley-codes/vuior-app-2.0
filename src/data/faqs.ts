...
export const MOBILE_FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    content:
      "Credits are applied after backend verification of your bill payment. When a bill status changes to Paid (green), credits are automatically calculated and added to your Available Credits balance.",
    category: "Credit Earned",
  },
  {
    value: "q11",
  ...
  },
  {
    ...
    content:
      "Unpaid (red) = bill has not been submitted for payment yet.\nPending (yellow) = bill is being verified for payment/processing. This buys time to verify bills before payment.\nPaid (green) = bill has been verified and payment confirmed. Credits are earned at this stage after backend verification.",
    category: "Others",
  },
  {
    value: "q26",
